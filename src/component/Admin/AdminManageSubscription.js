...
const ManageSubscription = () => {
    ...
    const handleEdit = (subscription) => {
        ...
        setFormData({
            ...
            company: subscription.company // Set company field
        });
    };
    ...
    const handleUpdateSubmit = async (e) => {
        ...
        try {
            ...
            fetchSubscriptions(); // Refresh the list
            setFormData({ vendorId: '', subscriptionType: '', startDate: '', endDate: '', serviceType: '', serviceName: '', amount: '', company: '' });
        } catch (error) {
                    ...
                    <tbody>
                        {subscriptions.map(subscription => (
                            <tr key={subscription.subId}> {/* Ensure the correct key is used */}
                                ...
                                <td>{subscription.company}</td> {/* Display company */}
                                <td>
                ...
                >
                    ...
                    <Modal.Body style={{ width: "400px" }}>
                        <Form onSubmit={handleUpdateSubmit}>
                            ...
                            <Form.Group className="mb-3">
                                <Form.Label>Company</Form.Label> {/* Added Company field */}
                                <Form.Control
                                    type="text"
                                    name="company"
